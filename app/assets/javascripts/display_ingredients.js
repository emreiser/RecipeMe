...
RecipeMe.displayIngredients = function(ingredients_list) {
  var $nav_tabs = $('<ul class="nav nav-tabs" id="myTab">'),
      ...
      $basket_button = $('<button id="find-recipe" class="btn btn-block btn-custom margin-bottom basket-btn disabled">Find Recipes</button>'),
      $find_recipe_button_div = $('<div id="find-recipe-button-div" class="col-sm-6 no-padding">'),
